...
for i in range(100):
    ...
    for url_plaatje in gevonden_verwijzingen:
        ...
        goed_image, img, file_naam = plaatjes_beoordelaar.laad_en_check_plaatje(
            url_plaatje=url_plaatje
        )
        if goed_image:
            plaatjes_beoordelaar.beoordeel_plaatje(
                img=img, url_plaatje=url_plaatje, file_naam=file_naam
            )
    print(
        "*******************************************************************************************************************************************"
    )
